...
const long period= 5; //200Hz. Old value:period=2000;                   //time between samples in milliseconds
...
//   Serial.println("Pressure KPa: " + String(pressureKPA,3));         //print KPa pressure
  Serial.print(pressureKPA);         //print KPa pressure
  Serial.print(","); Serial.print(-12);         //print KPa pressure
  Serial.print(","); Serial.println(10);         //print KPa pressure
